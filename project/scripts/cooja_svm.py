...
if conopts.input.endswith(".csv"):
    ...
    df_data.to_csv(f"{simul_dir}/../data-ws{window_size}-dp{detect_period}-asi{attack_standard_idx}.csv")
...
# -- filter rows
df_data = df_data[df_data['Trxr'] == 0.7]
